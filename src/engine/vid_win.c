...
void VID_InitMGLDIB(HINSTANCE hInstance)
{
	...
	strcpy(modelist[0].modedesc, "800x600");
	modelist[0].mode13 = 0;
	...
	modelist[2].width = 1400;
	modelist[2].height = 900;
	strcpy(modelist[2].modedesc, "1400x900");
	modelist[2].mode13 = 0;
...
// automatically stretch the default mode up if > 640x480 desktop resolution
	...
	if ((GetDeviceCaps(hdc, HORZRES) > 1024) && !COM_CheckParm("-noautostretch"))
	{
