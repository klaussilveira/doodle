...
static cvar_t sketch_lalpha           = { "sketch_lalpha", "0.30" };
static cvar_t sketch_lnumberwalls     = { "sketch_lnumberwalls", "8" };
static cvar_t sketch_lnumbermodels    = { "sketch_lnumbermodels", "3" };
static cvar_t sketch_lnumberparticles = { "sketch_lnumberparticles", "2" };
static cvar_t sketch_lnumberwater     = { "sketch_lnumberwater", "6" };

static cvar_t sketch_shadows		  = { "sketch_shadows", "0" };
...
EXPORT void dr_Init()
{
	...
	texNum[0] = loadRawFile("data/mat/mat1.raw");
	texNum[1] = loadRawFile("data/mat/mat2.raw");
	texNum[2] = loadRawFile("data/mat/mat3.raw");
	texNum[3] = loadRawFile("data/mat/mat4.raw");
	texNum[4] = loadRawFile("data/mat/mat5.raw");
	texNum[5] = loadRawFile("data/mat/mat1.raw");
	texNum[6] = loadRawFile("data/mat/mat2.raw");
	texNum[7] = loadRawFile("data/mat/mat3.raw");
	texNum[8] = loadRawFile("data/mat/mat4.raw");
	texNum[9] = loadRawFile("data/mat/mat5.raw");
...
EXPORT void EmitSkyPolys(msurface_t *fa, float speedscale, vec3_t r_origin)
{
	...
	for (p=fa->polys ; p ; p=p->next)
	{
		...
		for (i=0,v=p->verts[0] ; i<p->numverts ; i++, v+=VERTEXSIZE)
		{
			...
			s = (speedscale + dir[0]) * (1.0/512);
			t = (speedscale + dir[1]) * (1.0/512);
